<h2><a href="https://www.geeksforgeeks.org/problems/is-it-a-tree/1?page=2&category=Graph">Graph is Tree or Not</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">You are given an undirected graph of <strong>n</strong> nodes (numbered from 0 to n-1) and <strong>m</strong> edges. Return 1 if the graph is a tree, else return 0.</span></p>
